...
const ExamChapterSelectionPage = () => {
            ...
            <div className="mb-4 sm:mb-0">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
                  ...
                  style={{ width: `${(yearsList.filter(c => c.completed).length / yearsList.length) * 100}%` }}
                ></div>
              </div>
            </div>
            <div className="flex space-x-4">
              ...
              <div className="text-center">
                ...
                <div className="font-bold">
                  {yearsList.filter(c => c.completed).length}
                </div>
              </div>
            </div>
          </div>
          ...
          <AnimatePresence>
            {yearsList.map((year, index) => (
              <motion.div
                ...
                onClick={() => navigate(`/exams/${examId}/year/${index + 1}`)}
...
export default ExamChapterSelectionPage;