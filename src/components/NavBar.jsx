                  ...
                  <AnimatePresence>
                    {avatarOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-xl z-50 overflow-hidden border border-gray-200 dark:border-gray-700"
                        role="menu"
                      >
                        <div className="py-1">
                          <NavLink
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 h-full w-72 bg-white dark:bg-gray-900 z-50 shadow-2xl"
            >
